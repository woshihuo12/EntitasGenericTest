        ...
        public static void RegisterAll()
        {
            ...
            foreach (var assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                foreach (var type in assembly.GetTypes())
                {
                    ...
                    {
                        MethodInfo methodInfo = typeof(Lookup_ScopeManager).GetMethod(nameof(Lookup_ScopeManager.RegisterScope),
...

                    {
                        ...
                        MethodInfo methodInfo =
                            genericManagerType.GetMethod("Autoscan", BindingFlags.Static | BindingFlags.Public);
