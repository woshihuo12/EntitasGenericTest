...
namespace Entitas.Generic
{
    ...
    {
        void Sub(Entity<TScope> ent, Action<Entity<TScope>> action, Context<Entity<TScope>> context,
            bool triggerAfterSub = false);
        ...
        where TComp : IComponent, ICompFlag, IEvent_Self<TScope, TComp>, Scope<TScope>
    {
        ...
        public void Sub(Entity<TScope> ent, Action<Entity<TScope>> action, Context<Entity<TScope>> context,
            bool triggerAfterSub = false)
        {
